...
export class AlterUserTableToAddCreatedAtAndUpdateAt1747160066835
  implements MigrationInterface
{
  name = 'AlterUserTableToAddCreatedAtAndUpdateAt1747160066835';
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."user_role_enum_old" AS ENUM('admin', 'manager', 'user', 'tester')`,
    );
    await queryRunner.query(
      `ALTER TABLE "user" ALTER COLUMN "role" DROP DEFAULT`,
    );
